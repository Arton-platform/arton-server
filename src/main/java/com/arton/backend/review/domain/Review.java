...
public class Review extends Board {
    ...
    @Builder
    public Review(long reviewId, PerformanceEntity performance, String content, float starScore, User user, int hit, Image image, LocalDateTime createdDate, LocalDateTime updateDate) {
