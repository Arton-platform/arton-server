...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring()
                .antMatchers("/h2-console/**", "/favicon.ico", "/css/**", "/js/**", "/img/**", "/lib/**","/swagger-ui/**","/api-docs/**", "/home/godcoder/arton/arton-server/arton/image/**");
    }
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                "/auth/reset/password", "/auth/check/signup", "/artist/**", "/performance/**", "/terms/**", "/performance-sse/**", "/web/**").permitAll()
